...
class TestShopContactInfoForm(TestCase):
    ...
    def test_form_is_valid_if_phone_is_blank(self):
        ...
        self.assertTrue(form.is_valid(), msg='Form is not valid when phone is blank')
    ...
    def test_form_is_valid_if_email_is_blank(self):
        ...
        self.assertTrue(form.is_valid(), msg='Form is not valid when email is blank')
    ...
    def test_form_is_valid_if_town_is_blank(self):
        ...
        self.assertTrue(form.is_valid(), msg='Form is not valid when phone is town')
    ...
    def test_form_is_invalid_if_country_is_blank(self):
        ...
        self.assertFalse(form.is_valid(), msg='Form is valid when country is blank')
