...
class TestContactAndBillingForm(TestCase):
    ...
    def test_form_is_not_valid_if_first_name_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid first name missing')
    ...
    def test_form_is_not_valid_if_second_name_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid with missing second name')
    ...
    def test_form_is_not_valid_if_billing_street_address1_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid if street address 1 missing')
    ...
    def test_form_is_valid_if_billing_street_address2_missing(self):
        ...
        self.assertTrue(
            form.is_valid(),
            msg='Form is not valid with street address 2 missing')
    ...
    def test_form_is_not_valid_if_billing_town_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid with billing town missing')
    ...
    def test_form_is_not_valid_if_billing_county_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid with county missing')
    ...
    def test_form_is_not_valid_if_billing_postcode_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid without billing postcode')
...
class TestShippingForm(TestCase):
    ...
    def test_form_is_not_valid_with_street_address1_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid without shipping address 1')
    ...
    def test_form_is_valid_with_street_address2_missing(self):
        ...
        self.assertTrue(
            form.is_valid(),
            msg='Form is not valid without shipping address 2')
    ...
    def test_form_is_not_valid_with_town_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid without shipping town')
    ...
    def test_form_is_not_valid_with_county_missing(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Form is valid without shipping county')
    ...
    def test_form_is_not_valid_with_country_missing(self):
        ...
        self.assertTrue(
            form.is_valid(),
            msg='Form is not valid without shipping country')
    ...
    def test_form_is_valid_with_gift_message_missing(self):
        ...
        self.assertTrue(
            form.is_valid(),
            msg='Form is not valid without gift message')
