...
class TestCheckoutViews(TestCase):
    ...
    def test_render_checkout_successpage(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(
            b'A confirmation email will be sent to',
            response.content)
    ...
    def test_different_authenticated_user_cannot_access_cancel_order_view_of_another_customer(
            self):
